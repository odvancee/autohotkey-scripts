; Prefix-based Obsidian search (Omnisearch plugin) with a GUI prompt.
; Enter a prefix before your search query to select the vault you want to search in.
; Example: entering "p cookie" sends "cookie" to the Omnisearch engine in your Personal vault.
...
ButtonOK:
	...
	Run, obsidian://omnisearch?vault=%vault%&query=%query_text%
